function createRegionDFigure(actual, ua, beta, Ubeta, dataName, phi, psi, SixSigmaRule)
% createRegionDFigure - Plot Region D with comparison lines
%
% This function creates a figure showing (fitted - actual) differences
% including confidence bounds and tolerance lines (Region D).
%
% Inputs:
...
% Create fine grid around selected actual value
...
% Save figure
savefig(sprintf('Fig_%s_RegionD.fig', dataName));
